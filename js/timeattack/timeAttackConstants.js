...
export const TIME_ATTACK_BLADE_DAMAGE = 2; // 1 → 2
export const TIME_ATTACK_BLADE_KNOCKBACK = 60;
export const TIME_ATTACK_BLADE_ROTATION_CYCLE = 3; // 3바퀴마다 비활성화
export const TIME_ATTACK_BLADE_INACTIVE_DURATION = 2; // 2초간 비활성화
export const TIME_ATTACK_BLADE_FADE_DURATION = 0.3; // 페이드 애니메이션 시간 (초)
